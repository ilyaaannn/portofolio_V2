...
export default function SectionHeading({
  ...
  return (
    <motion.div
      ...
      className={isCenter ? "text-center mx-auto max-w-2xl" : "text-left"}
    >
      <span className="inline-flex items-center gap-2 font-mono text-sm font-medium text-primary-600">
      ...
      {description && (
        <p className={`mt-4 text-base leading-relaxed text-muted ${isCenter ? "mx-auto" : ""} max-w-xl`}>
          {description}
        </p>
      )}
    </motion.div>
